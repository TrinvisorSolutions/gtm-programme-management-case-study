...
function renderKpis(kpis) {
  ...
  const labels = {
    ...
    content_assets_in_flight:
      ["Content assets in flight", ""],

    video_event_assets_in_production:
      ["Video / event assets in production", ""],

    event_campaign_activations:
      ["Event / campaign activations", ""],

    stakeholder_actions_overdue:
      ["Overdue stakeholder actions", ""]
...
function renderWorkstreams(workstreams) {
  ...
  const container =
    document.getElementById("workstreams");
      ...
      .map(workstream => `
        ...
        <div class="workstream">
          ...
          <div class="workstream-head">
            ...
            <span
              class="status ${workstream.status.toLowerCase()}"
            >
              ${workstream.status}
            </span>
          ...
          <div class="workstream-meta">
            ...
            <span>
              ${workstream.progress}% complete
            </span>

            <span>
              Next: ${workstream.next}
            </span>
          ...
          ${risks.map(risk => `
            ...
            <tr>
              ...
              <td>
                ...
                <span
                  class="status ${risk.status.toLowerCase()}"
                >
                  ${risk.status}
                </span>
